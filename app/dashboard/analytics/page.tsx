...
function AnalyticsPageContent() {
  ...
  const [data, setData] = useState<UserData>({ accounts: [], income: [], expenses: [] });
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const accounts: Account[] = (accountsData || []).map((acc) => ({
          ...
          type: acc.is_asset ? "asset" : "liability",
        }));

        const income: Income[] = (incomeData || []).map((inc) => ({
          source: inc.source,
          amount: Number(inc.amount) || 0,
          frequency: inc.frequency as "weekly" | "biweekly" | "monthly" | "yearly",
        }));
        ...
        const expenses: Expense[] = (expensesData || []).map((exp) => ({
          ...
          frequency: (exp.frequency || "monthly") as
            | "weekly"
            | "biweekly"
            | "monthly"
            | "yearly",
        ...
        setData({ accounts, income, expenses });
        setHasData(accounts.length > 0 || income.length > 0 || expenses.length > 0);
      } catch (error) {
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-8">
            ...
            <div className="mb-4 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-base-content/60 mt-1">
                Insights into your financial health and monthly patterns
              </p>
            </div>

            {/* Empty State */}
            <div className="flex items-center justify-center py-12">
              <div className="card bg-base-100 shadow-xl border border-base-content/10 max-w-2xl w-full">
                <div className="card-body text-center p-8 sm:p-12">
                  ...
                  <p className="text-base-content/70 mb-8 text-sm sm:text-base">
                    Start tracking your finances to see powerful analytics and
                    insights. Add your accounts, income sources, and expenses to
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    ...
                    >
                      <svg
                        ...
                        className="w-5 h-5"
                      >
                        <path d="M4 4a2 2 0 00-2 2v1a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4z" />
                        <path
                          fillRule="evenodd"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-8">
              ...
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-lg sm:text-2xl font-bold text-success mt-1 break-words">
            ...
            <div className="card bg-gradient-to-br from-accent/20 to-accent/5 border border-accent/30">
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] sm:text-xs font-semibold text-accent/70 uppercase tracking-wider">
                      Monthly Income
                    </div>
                    <div className="text-lg sm:text-2xl font-bold text-accent mt-1 break-words">
              ...
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-lg sm:text-2xl font-bold text-error mt-1 break-words">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-error/20 flex items-center justify-center shrink-0 ml-2">
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      className="w-5 h-5 sm:w-6 sm:h-6 text-error"
                    >
                      <path d="M3 4a2 2 0 00-2 2v1.161l8.441 4.221a1.25 1.25 0 001.118 0L19 7.162V6a2 2 0 00-2-2H3z" />
                      <path d="M19 8.839l-7.77 3.885a2.75 2.75 0 01-2.46 0L1 8.839V14a2 2 0 002 2h14a2 2 0 002-2V8.839z" />
                    </svg>
                ...
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    <div
                      className={`text-[10px] sm:text-xs font-semibold ${
                        monthlySavings >= 0 ? "text-primary/70" : "text-warning/70"
                    ...
                    <div
                      className={`text-lg sm:text-2xl font-bold ${
                        monthlySavings >= 0 ? "text-primary" : "text-warning"
                      } mt-1 break-words`}
                    >
                  ...
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full ${
                      monthlySavings >= 0 ? "bg-primary/20" : "bg-warning/20"
              ...
              <div className="card-body">
                <div className="flex items-center gap-2">
                  ...
                  <div
                    ...
                    data-tip="Formula: (Monthly Income - Monthly Expenses) ÷ Monthly Income × 100. Shows what percentage of your income you're saving."
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      className="w-4 h-4 text-base-content/40 hover:text-base-content/60 cursor-help"
                    >
                      <path
                        fillRule="evenodd"
            ...
            >
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center gap-1 sm:gap-2">
                  <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider opacity-70">
                    Asset to Debt Ratio
                  </div>
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Formula: Total Assets ÷ Total Liabilities. Measures how many dollars of assets you have for every dollar of debt. A ratio of 2:1 or higher is excellent."
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-base-content/40 hover:text-base-content/60 cursor-help shrink-0"
                    >
                      <path
                        fillRule="evenodd"
                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zM8.94 6.94a.75.75 0 11-1.061-1.061 3 3 0 112.871 5.026v.345a.75.75 0 01-1.5 0v-.5c0-.72.57-1.172 1.081-1.287A1.5 1.5 0 108.94 6.94zM10 15a1 1 0 100-2 1 1 0 000 2z"
            ...
            >
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Formula: Total Assets ÷ Monthly Expenses. Shows how many months you could survive on savings if income stopped. Financial experts recommend 3-6 months."
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                ...
                <div className="text-2xl sm:text-3xl font-bold mt-2 break-words">
                  {monthlyExpenses > 0
                    ? Math.floor(totalAssets / monthlyExpenses)
                    : 0}{" "}
                  mo.
                </div>
                <div className="text-[10px] sm:text-xs mt-2 opacity-70">
                  {totalAssets >= monthlyExpenses * 6
                    ? "Excellent"
                    : totalAssets >= monthlyExpenses * 3
                      ? "Good"
                      : "Needs Improvement"}
                </div>
              </div>
              ...
              <div className="card-body p-3 sm:p-4">
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div
                    ...
                    data-tip="Grade based on Net Worth and Savings Rate: A+ = positive net worth + 20%+ savings rate, B = positive + 10%+ savings, C = positive net worth, D = negative net worth."
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                ...
                <div className="text-2xl sm:text-3xl font-bold mt-2 break-words">
                  {netWorth >= 0 && savingsRate >= 20
                    ? "A+"
                    : netWorth >= 0 && savingsRate >= 10
                      ? "B"
                      : netWorth >= 0
                        ? "C"
                        : "D"}
